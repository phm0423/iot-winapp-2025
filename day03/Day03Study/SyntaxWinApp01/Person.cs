namespace SyntaxWinApp01
{
    ...
    internal class Person
    {
        ...
        public string Name { get; set; } // getName, setName을 다 자동생성

        // Age int이기 때문에 -21억 ~ 21억
        // 그냥 값을 받고 사용할때는 public int Age { get; set; }로 사용
        // 0 ~ 200 사이만 들어가도록 변경
        private int age;
        ...
        public void GetUp()
        {
            MessageBox.Show($"{Name}이(가) 일어납니다.");
        }
